...
const About = () => {
  return (
    <>
      <section className="w-full h-full min-h-screen bg-slate-200 text-slate-100 p-4 md:px-32 relative z-[1]">
        <div className="w-full min-h-screen flex flex-col md:flex-row items-center justify-center md:justify-between mt-10 md:my-0">
          <div className="w-full md:w-1/2 p-4 md:p-12 flex flex-col items-center md:items-start">
            ...
            >
              <motion.button
                whileTap={{ scale: 1.05 }}
                className="font-semibold px-4 py-2 rounded-xl border-2 border-sky-700 bg-sky-700 hover:bg-transparent transition-colors mt-4 mx-auto md:mx-0 text-slate-100/90 shadow-sm"
              >
                Testimonials
              </motion.button>
            </a>
          ...
          <div className="w-full md:w-1/2 p-4 md:p-12 flex items-center justify-center select-none relative overflow-hidden group">
            <div className="w-2/3 h-2/3 md:w-1/2 md:h-1/2 m-auto absolute z-0 bg-sky-700/50 group-hover:bg-sky-700/70 group-hover:scale-105 rounded-full blur-xl" />
            <img
              draggable="false"
      ...
      <section
        ...
        className="w-full bg-slate-200 py-16 px-8 flex"
      >
        <div className="grid grid-cols-1 lg:grid-cols-4 lg:grid-rows-2 gap-6 text-slate-100 antialiased">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 rounded-lg cursor-pointer lg:col-span-2 bg-sky-700/90 ring-2 ring-transparent hover:ring-sky-400/20 shadow-2xl relative"
          >
            <FaQuoteRight className="absolute p-2 size-12 md:size-16 right-2 top-2 opacity-50" />
            ...
            <p className="mt-2 text-slate-100/90 text-sm leading-4 md:text-base">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
            viewport={{ once: true }}
            className="p-8 rounded-lg cursor-pointer bg-sky-700/90 ring-2 ring-transparent hover:ring-sky-400/20 shadow-2xl relative"
          >
            <FaQuoteRight className="absolute p-2 size-12 md:size-16 right-2 top-2 opacity-50" />
            <div className="flex items-center">
              <img
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
            viewport={{ once: true }}
            className="p-8 rounded-lg cursor-pointer bg-sky-700/90 ring-2 ring-transparent hover:ring-sky-400/20 shadow-2xl lg:col-span-2 row-start-2 relative"
          >
            <FaQuoteRight className="absolute p-2 size-12 md:size-16 right-2 top-2 opacity-50" />
            <div className="flex items-center">
              <img
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
            viewport={{ once: true }}
            className="p-8 rounded-lg cursor-pointer bg-sky-700/90 ring-2 ring-transparent hover:ring-sky-400/20 shadow-2xl lg:row-span-2 lg:row-start-1 lg:col-start-4 relative"
          >
            <FaQuoteRight className="absolute p-2 size-12 md:size-16 right-2 top-2 opacity-50" />
            <div className="flex items-center">
              <img
